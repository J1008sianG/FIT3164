...
ui <- navbarPage("MDS9",
  ...
  tabPanel("About",
           ...
           h2(HTML("<b> Article Classification Model </b>"), 
           ...
           h2(HTML(" - Classify the findability of the uploaded article based on the placement of text."), 
              style="text-align:left"),
           
           br(),
           
           h2(HTML(" - The findability of the uploaded article will be classified based on the keywords from the title and the appearances of the keywords in the text."), 
              style="text-align:left"),
           
           br(),
           
           h2(HTML(" - The findability of the article is mainly determine by the density of the appearences of the keywords from the article title in the different placement especially in the abstract and paragraphs."), 
              style="text-align:left"),
           ...
           h2(HTML(" - There are also some related keyowrds provided from the entire article according to the appearences and weightage."), 
              style="text-align:left"),
           
           br(),
           
           h2(HTML(" - Some limitations of the model include the uploaded article needs to be convert into xml type and some characters from the suggested keywords are be removed."), 
              style="text-align:left")
